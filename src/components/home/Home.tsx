...
const Home = (): JSX.Element => {
    ...
    const showMenuHandler = () => {
        ...
        setTimeout(() => {
            ...
            timeline
                .add(getAnimeTimelineParams('.item-create', 0, '2.5rem', 'visible'))
                .add(getAnimeTimelineParams('.item-get-all', '4rem', '4.5rem', 'visible'))
                .add(getAnimeTimelineParams('.item-get-single', '-4rem', '4.5rem', 'visible'))
                .add(getAnimeTimelineParams('.item-delete', '4rem', '0.5rem', 'visible'))
                .add(getAnimeTimelineParams('.item-update', '-4rem', '0.5rem', 'visible'))
        }, 500);
    };
    ...
    const hideMenuHandler = () => {
        ...
        timeline
            .add(getAnimeTimelineParams('.item-create', 0, '6.5rem', 'hidden'))
            .add(getAnimeTimelineParams('.item-get-all', 0, '6.5rem', 'hidden'))
            .add(getAnimeTimelineParams('.item-get-single', 0, '6.5rem', 'hidden'))
            .add(getAnimeTimelineParams('.item-delete', 0, '6.5rem', 'hidden'))
            .add(getAnimeTimelineParams('.item-update', 0, '6.5rem', 'hidden'))
    ...
    const svgArrowRenderer = () => {
        return (
            <svg width="150pt" height="100pt" version="1.1" viewBox="0 0 700 550" xmlns="http://www.w3.org/2000/svg">
    ...
    const sidebarToggleHandler = () => {
        ...
        anime({
            targets: '.sidebar',
            width: showSidebar ? '5vw' : '20vw',
            duration: 400,
            easing: 'easeInOutExpo'
        });

        anime({
            targets: '.sidebar-toggle',
                    ...
                    <div className="sidebar">
                        <div className="sidebar-header flex">
                            <div className="sidebar-toggle" onClick={() => sidebarToggleHandler()}>
                                <i className={showSidebar ? 'pi pi-times' : 'pi pi-bars'}></i>
                            </div>
                        </div>
                    </div>
                    <div className="flex-auto flex flex-column h-full">
                        ...
                        <div 
                            className={showMenu ? 'h-10rem flex justify-content-center' : 'h-3rem flex justify-content-center'}
                        >
                            <button 
                            ...
                            >
                                <i className={showMenu ? 'pi pi-times' : 'pi pi-bolt'}></i>
                            </button>
                        ...
                        <div className="mt-4 flex-auto flex justify-content-center">
